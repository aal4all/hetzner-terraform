...
# https://build.opensuse.org/package/view_file/network:ha-clustering:Stable/crmsh/crmsh.spec?expand=1
...
Url:            https://github.com/ClusterLabs/crmsh/archive/4.2.0.tar.gz
